...
CLASS lhc_Agency IMPLEMENTATION.
  ...
  METHOD validateCountryCode.
    ...
    READ ENTITIES OF ZJS_R_AgencyTP IN LOCAL MODE
      ENTITY Agency
        FIELDS ( CountryCode )
    ...
    LOOP AT agencies INTO DATA(agency).
      ...
      IF   agency-CountryCode IS INITIAL
        ...
        APPEND VALUE #(
            %tky                 = agency-%tky
            %state_area          = state_area_validate_country
            %msg                 = NEW zjs_cx_agency(
                                       textid      = zjs_cx_agency=>country_code_invalid
    ...
    LOOP AT agencies INTO DATA(agency).
      ...
      IF CONV string( agency-emailaddress ) NP '+*@+*.+*'.
        ...
        APPEND VALUE #(
            %tky                  = agency-%tky
            %state_area           = state_area_validate_email
            %msg                  = NEW zjs_cx_agency( zjs_cx_agency=>email_invalid_format )
    ...
    LOOP AT Agencies INTO DATA(Agency).
      ...
      IF Agency-Name IS INITIAL.
        ...
        APPEND VALUE #(
            %tky          = Agency-%tky
            %state_area   = state_area_validate_name
            %msg          = NEW zjs_cx_agency( zjs_cx_agency=>name_required )
...
CLASS lsc_agency IMPLEMENTATION.
  ...
  METHOD adjust_numbers.
    DATA:
      agency_id_max TYPE zjs_de_agency_id,
      entity        TYPE STRUCTURE FOR MAPPED LATE ZJS_R_AgencyTP.
    ...
    CASE number_range_return_code.
      WHEN '1'.
        ...
        LOOP AT entities_wo_agencyid INTO entity.
          APPEND VALUE #(
              ...
              %key = entity-%key
              %msg = NEW zjs_cx_agency(
                          textid   = zjs_cx_agency=>number_range_depleted
      ...
      WHEN '2' OR '3'.
        ...
        RAISE SHORTDUMP NEW zjs_cx_agency( textid   = zjs_cx_agency=>not_sufficient_numbers
                                            severity = if_abap_behv_message=>severity-warning ).
    ENDCASE.
