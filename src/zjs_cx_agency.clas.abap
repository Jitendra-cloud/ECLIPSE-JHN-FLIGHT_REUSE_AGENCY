CLASS zjs_cx_agency DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      message_class TYPE symsgid VALUE 'ZJS_CM_AGENCY',
    ...
    DATA:
      mv_country_code TYPE ZJS_R_AgencyTP-CountryCode,
      mv_numbers_left TYPE i,
      mv_attachment     TYPE ZJS_R_AgencyTP-attachment,
      mv_mimetype       TYPE ZJS_R_AgencyTP-mimetype,
      mv_filename       TYPE ZJS_R_AgencyTP-Filename.
    ...
    METHODS:
      constructor
        IMPORTING
          ...
          countrycode  TYPE ZJS_R_AgencyTP-CountryCode      OPTIONAL
          numbers_left TYPE i                                OPTIONAL
          attachment   TYPE ZJS_R_AgencyTP-attachment      OPTIONAL
          mimetype     TYPE ZJS_R_AgencyTP-mimetype        OPTIONAL
          filename     TYPE ZJS_R_AgencyTP-Filename        OPTIONAL
...
CLASS ZJS_CX_AGENCY IMPLEMENTATION.
